#
#  Be sure to run `pod spec lint PonyFrameworkOnSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ponycoder"
  # s.authors            = { "ponycoder" => "571533442@qq.com" }
  # s.social_media_url   = "http://twitter.com/ponycoder"
